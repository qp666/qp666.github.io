  ...
  themeConfig: {
    ...
    nav: [
      { text: '关于本博客', link: '/AboutMe.md' },
      {
        text: '前端开发',
        items: [
          { text: 'Vue 与组件库', link: '/juejin/vue/index.html' },
          { text: 'JavaScript 与 CSS', link: '/juejin/javascript/index.html' },
          { text: '网络与浏览器', link: '/juejin/web-network/index.html' },
        ],
      },
      {
        text: '工程实践',
        items: [
          { text: '工程化与开发工具', link: '/juejin/engineering-tools/index.html' },
          { text: '微信小程序与 UniApp', link: '/juejin/wechat-uniapp/index.html' },
          { text: '移动端开发', link: '/juejin/mobile/index.html' },
        ],
      },
      { text: '其他技术笔记', link: '/juejin/other/index.html' },
      /*
      { text: '关于本博客', link: '/AboutMe.md' },
      {
        text: '安卓基础入门知识',
